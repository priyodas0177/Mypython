...
# This is admin personal information page. in here admin just see this information.
![image alt](https://github.com/priyodas0177/Mypython/blob/main/Screenshots/personal%20information.png)

# This is attendance page. here see can see the attendance details. Rules ( 
if user login after 9.30am then he is late present. and if user login before 6pm then he is early leave.
this app works for company domain network.
)
![image alt](https://github.com/priyodas0177/Mypython/blob/main/Screenshots/attendance.png)
